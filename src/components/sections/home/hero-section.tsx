          ...
          <div className="relative pt-24 md:pt-36">
            ...
            <div className="mx-auto max-w-7xl px-6">
              <div className="text-center sm:mx-auto lg:mt-0 lg:mr-auto">
                <AnimatedGroup variants={transitionVariants}>
                  ...
                  <div className="flex justify-center">
                    <div className="bg-primary/10 rounded-full p-6">
                      <ChefHat className="text-primary h-16 w-16" />
                    </div>
                  </div>
                </AnimatedGroup>
                ...
                >
                  Find Recipes from What's in Your Kitchen 🍳
                </TextEffect>
                <TextEffect
                  per="line"
                  preset="fade-in-blur"
                ...
                >
                  Cook delicious meals with ingredients you already have. No
                  more wondering "what's for dinner?"
                </TextEffect>
                ...
                >
                  ...
                  >
                    ...
                    >
                      <Link to="/pantry">
                        <span className="text-nowrap">Start My Pantry</span>
                      </Link>
                    </Button>
                  </div>
                </AnimatedGroup>
